...
export const EntityContainer = ({
    ...
    return (
        ...
        <div className="p-4 md:px-10 md:py-6 h-full">
            <div className="mx-auto max-w-7xl h-full gap-y-8 w-full flex flex-col">
                {header}
...
export const EntitySearch = ({
    ...
    return (
        <div className="relative ml-auto">
            <SearchIcon className="size-3.5 absolute left-3 -translate-y-1/2 text-muted-foreground top-1/2" />
...
export const LoadingView = ({
    ...
    return (
        <div className="flex justify-center gap-y-4 items-center h-full flex-1 flex-col">
